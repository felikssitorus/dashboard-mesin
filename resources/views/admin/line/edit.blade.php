...
@section('title')
    Edit Permission Line Manage
@endsection
@section('page_title')
    Edit Permissions Line Manage
@endsection
@section('breadcrumb')
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item text-muted">Edit Permission Line Manage</li>
    </ul>
@endsection
                    ...
                    <div class="card">
                            ...
                            <div class="card-title">
                                <div class="row">
                                    <div class="col-12 mb-0 py-0">
                                        <h5 class="my-0">Edit Permission Line Manage</h5>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="card-content">
                                <form action="{{ route('admin.permissionLine.update', $line->id) }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="form-check">
                                                            <input type="checkbox" name="urls[]" value="{{ $routeName }}"
                                                                ...
                                                                {{ in_array($routeName, optional($line->permission)->pluck('url')->toArray() ?? []) ? 'checked' : '' }}>
